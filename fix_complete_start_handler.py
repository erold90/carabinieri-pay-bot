...
print("🔧 Fix completo start_handler.py")
print("=" * 50)

# Riscriviamo completamente il file start_handler.py con una versione funzionante
start_handler_content = '''"""
...
print("1️⃣ Scrivo il file corretto...")
with open('handlers/start_handler.py', 'w') as f:
    f.write(start_handler_content)

print("✅ File riscritto completamente!")

# Aggiorniamo anche calculation_service.py per gestire gli errori
print("\n2️⃣ Fix calculate_month_totals...")
...
# Aggiungi la funzione a calculation_service.py
with open('services/calculation_service.py', 'a') as f:
    f.write('\n\n' + calc_service_fix)

print("✅ Aggiunta gestione errori a calculation_service.py")

# Commit e push
print("\n3️⃣ Commit e push...")
subprocess.run("git add handlers/start_handler.py services/calculation_service.py", shell=True)
subprocess.run('git commit -m "fix: risolto errore NoneType in start_command"', shell=True)
subprocess.run("git push origin main", shell=True)

print("\n" + "=" * 50)
print("✅ Fix completato!")
print("\n⏰ Attendi 2-3 minuti per il deploy")
print("📱 Poi riprova /start su Telegram")
print("\n💡 Il bot dovrebbe rispondere con il menu principale!")
