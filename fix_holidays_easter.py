...
print("🔧 Fix errore holidays.easter")
print("=" * 50)

# Modifica calculation_service.py per fixare l'errore easter
calculation_fix = '''"""
...
with open('services/calculation_service.py', 'w') as f:
    f.write(calculation_fix)

print("✅ Fixato calculation_service.py con calcolo Pasqua integrato")

# Aggiungi anche l'import mancante di ServiceType
print("\n📝 Aggiungo import ServiceType...")

# Leggi il file
with open('services/calculation_service.py', 'r') as f:
    content = f.read()

# Aggiungi import dopo gli altri
import_line = 'from database.models import User, Service, Overtime, OvertimeType'
new_import = 'from database.models import User, Service, Overtime, OvertimeType, ServiceType'
...
print("✅ Aggiunto import ServiceType")

# Commit e push
print("\n📤 Commit e push...")
subprocess.run("git add services/calculation_service.py", shell=True)
subprocess.run('git commit -m "fix: corretto errore holidays.easter con calcolo Pasqua integrato"', shell=True)
subprocess.run("git push origin main", shell=True)

print("\n" + "=" * 50)
print("✅ Fix completato!")
print("📅 Il calcolo di Pasqua ora funziona correttamente")
print("🎯 Prova di nuovo a inserire un nuovo servizio!")
